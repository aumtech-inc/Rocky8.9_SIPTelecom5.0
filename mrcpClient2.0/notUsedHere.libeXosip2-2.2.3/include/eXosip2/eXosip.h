 ...
 */
  ...
  int eXosip_modify_authentication_info(const char *username, const char *userid,
                     const char *passwd, const char *ha1,
                     const char *realm);
  ...
  typedef enum eXosip_event_type
    {
      ...
      EXOSIP_CALL_BYE_ACK,           /*YYQ: DDN added call BYE  is acknowledged. 22*/
...
/* YYQ: updated: DDN_ADDED*/
  int                             dtmf;
  int                             notifyType;
  char                            transferResult[50];
/*END: DDN_ADDED*/
  };
