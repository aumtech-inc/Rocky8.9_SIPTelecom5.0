...
Date:		10/16/2000
Update: 040901 APJ Added parameter validation.
Update: 043001 APJ Took out ';' after if parametersAreGood call.
Update: 050801 APJ Put validation for characters in dtmf_string.
Update: 01/19/2005 djb Corrected log error messages. Too many %s's
------------------------------------------------------------------------------*/
#include "TEL_Common.h"

static int parametersAreGood(char *mod, const char *dtmf_string);

int TEL_OutputDTMF(const char * dtmf_string) 
{
	static char mod[]="TEL_OutputDTMF";
