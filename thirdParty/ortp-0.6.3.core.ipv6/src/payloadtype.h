...
extern RtpProfile av_profile_array_out[MAX_PORTS];
extern RtpProfile av_profile_array_in[MAX_PORTS];
extern RtpProfile av_video_profile_array_out[MAX_PORTS];
extern RtpProfile av_video_profile_array_in[MAX_PORTS];
//extern RtpProfile av_mrcp_profile_array_sr[MAX_PORTS];
