...
RtpProfile av_profile_array_out[MAX_PORTS];
RtpProfile av_profile_array_in[MAX_PORTS];

RtpProfile av_video_profile_array_out[MAX_PORTS];
RtpProfile av_video_profile_array_in[MAX_PORTS];

//RtpProfile av_mrcp_profile_array_sr[MAX_PORTS];
...
void av_profile_init(RtpProfile *profile)
{
	...
	rtp_profile_set_payload(profile,96 ,&telephone_event);
	rtp_profile_set_payload(profile,101 ,&telephone_event);
	rtp_profile_set_payload(profile,120 ,&telephone_event);
	rtp_profile_set_payload(profile,127 ,&telephone_event);
}
