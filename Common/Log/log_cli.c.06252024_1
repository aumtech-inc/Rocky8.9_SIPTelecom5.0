...
extern void GetLogPaths(char *LogPath_1, char *LogPath_2);
extern int WriteLocal(char *LogPath_1, char *Message, int forward_sw);
extern int GetLogServer(char *Server, char *NodeName);
