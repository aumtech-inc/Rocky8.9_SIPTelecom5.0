...
static	int	dead_application[MAX_PROCS];  /* store the killed appli. pid */
static	int	dead_appl_stat[MAX_PROCS];  /* store status of killed appli. */
