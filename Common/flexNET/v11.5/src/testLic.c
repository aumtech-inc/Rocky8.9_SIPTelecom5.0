...
//	}
	...
	fprintf(stderr, "Sleeping indefinitely in a loop...\n");
//	for( ;; )
//	{
		ySleepTime=10;
		fprintf(stderr, "Sleeping %d, licenseOK=%d\n", ySleepTime, licenseOK);
		sleep(ySleepTime);
		if ( licenseOK > 3 )
		{
			fprintf(stderr, "BONK!!!  licenseOK=%d\n", licenseOK);
			licShutdown();
		}
//	}
