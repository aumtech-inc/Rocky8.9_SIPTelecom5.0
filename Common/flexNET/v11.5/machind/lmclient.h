...
#define LM_SSIDNULL				-180 /** Internal Error - 180. Please report to Macrovision Corporation. */
#define LM_SMTXNOTREL			-181 /** Internal Error - 181. Please report to Macrovision Corporation. */
#define LM_MTXNOPERM			-182 /** Internal Error - 182. Please report to Macrovision Corporation. */
#define LM_LAST_ERRNO			-182  /** The last valid error number */
/*  WARNING
