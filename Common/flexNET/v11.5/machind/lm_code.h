 ...
 *				(unlike LM_SEEDs).
 */
#define VENDOR_KEY1 0x0ad03e01
#define VENDOR_KEY2 0x21cb1da4
#define VENDOR_KEY3 0x8a68be90
#define VENDOR_KEY4 0xd4396b17
#define VENDOR_KEY5 0x276036fc

/*
 * 	Vendor name.  		Leave "demo" if evaluating.  Otherwise,
 *			 	set to your vendor daemon name.
 */
#define VENDOR_NAME "arclicd"
/*
 ...
 */
#define LM_SEED1 0xecd29fc8
#define LM_SEED2 0xe87fade4
#define LM_SEED3 0xa24b9cba
/*
 *	Pick an LM_STRENGTH:
 */
 ...
 */
#define TRL_KEY1    0xc9ee200b
#define TRL_KEY2    0x56191569
