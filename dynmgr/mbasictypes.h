...
public:
    ...
    /**
      ...
      */
    BOOL    operator == (const CMUnsignedInt64& o) { return ((low == o.LowLong()) && (high == o.HighLong()));}
    BOOL    operator == (unsigned long l) { return ((high==0) && (low == l));}

    /**
      * Compare the object to another CMUnsignedInt64 value
      * @return TRUE if object is greater than the argument, FALSE if the object is less than or equal to the argument
      */
    BOOL    operator >  (const CMUnsignedInt64& o) { return ((high >  o.HighLong()) || ((high==o.HighLong()) && (low >  o.LowLong()))); }
    BOOL    operator >  (unsigned long l) { return ((high > 0) || ((high==0) && (low >  l)));}
...
/** Checks if the computing system processes data in big-Endian style.
  ...
  */
M_IMPORT extern BOOL MBigEndian();
